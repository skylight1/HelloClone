...
public class BasicCustomVideoRenderer extends BaseVideoRenderer{
    ...
    static class MyRenderer implements GLSurfaceView.Renderer {
        ...
        public MyRenderer(BasicCustomVideoRenderer parent, Clone mclone) {
    ...
    public BasicCustomVideoRenderer(Context context, Clone mclone) {
        this.mContext = context;

        mView = new GLSurfaceView(context);
        mView.setEGLContextClientVersion(2);

        mRenderer = new MyRenderer(this, mclone);
