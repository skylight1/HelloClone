...
public class CustomVideoCapturer extends BaseVideoCapturer implements
    ...
    private final static int PREFERRED_CAPTURE_WIDTH =  480;//720;//480;
    private final static int PREFERRED_CAPTURE_HEIGHT = 640;//1280;//640;
...
//        Log.e(LOGTAG,"mCaptureWidth * mCaptureHeight :" +
//                String.valueOf(mCaptureWidth) + ":" + String.valueOf(mCaptureHeight ));
    ...
    private void configureCaptureSize(int preferredWidth, int preferredHeight) {
        ...
        mCaptureFPS = maxFPS;
        mCaptureFPS = 20;
        Log.e(LOGTAG,"captureFPS:"+ mCaptureFPS);
        ...
        Log.e(LOGTAG,"smCaptureWidth * smCaptureHeight :" +
                String.valueOf(mCaptureWidth) + ":" + String.valueOf(mCaptureHeight));
    ...
    public void init() {
        try {
            ...
            Log.e(LOGTAG, "Failed to start camera", e);
        }
